...
type Config struct {
	...
	NotificationLookback time.Duration `hcl:"notification_lookback" env:"NOTIFICATION_LOOKBACK" default:"168h"`
	...
	OpenAIModel          string        `hcl:"openai_model" env:"OPENAI_MODEL" default:"gpt-4o-mini"`
}
